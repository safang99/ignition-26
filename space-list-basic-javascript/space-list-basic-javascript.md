...
The researcher told you that you need **5 rocks**, **2 insects**, and **4 twigs**, but they forgot to tell you how many **plants** to get. Each space rock costs **$0.50**, each water sample costs **$2.00**, each soil sample costs **$2.50**, and each plant is **$2.00**.
